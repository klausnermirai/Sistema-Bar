...
import { Product, Purchase, SaleRecord, Expense, Supplier, User } from './types';
...
export const INITIAL_EXPENSES: Expense[] = [
  { id: 'e1', date: '2025-01-03', supplier: 'PLASFER', description: 'Copos e Guardanapos', amount: 527.00, category: 'Materiais' },
  { id: 'e2', date: '2025-01-03', supplier: 'PLASFER', description: 'Sacolas (Extra)', amount: 140.00, category: 'Materiais' },
  { id: 'e3', date: '2025-01-05', supplier: 'MERCADO EXTRA', description: 'Produtos Limpeza Geral', amount: 107.88, category: 'Limpeza' },
];

export const INITIAL_PURCHASES: Purchase[] = [
  { id: 'p1', date: '2025-01-07', productId: '1', supplierName: 'LUIS DOCE', quantityPackages: 55, totalCost: 4587.00, unitCostSnapshot: 0.35 }, // Gelinho
  { id: 'p2', date: '2025-01-07', productId: '8', supplierName: 'GARATINI', quantityPackages: 1080, totalCost: 3769.20, unitCostSnapshot: 3.49 }, // Coca
];